...
function irp_ui_button_editor() {
    ...
    $irp->Form->formStarts('post', '', $args);
    {
        ...
        <p style="text-align:right;">
            <input type="button" id="btnInsert" class="button button-primary irp-button irp-submit" value="<?php $irp->Lang->P('تایید')?>"/>
            <input type="button" id="btnClose" class="button irp-button" value="<?php $irp->Lang->P('لغو')?>"/>
        </p>
